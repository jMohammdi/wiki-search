...
function Setting({ column2, activeElement, setColumn2 }: ColumnProps) {
  return <div className=' w-96 border'>
    <div className='w-full p-2 text-center text-white text-base bg-cyan-400'>
      Settings
    </div>
    {column2.length > 0 && <ProviderSettings elementProps={column2} activeElId={activeElement} setColumn2={setColumn2} />}
